    ...
    <div className="animate-fade-in">
      ...
      <div className="relative my-4">
        ...
        <div className="relative flex justify-center text-xs text-dark-muted">
          <span className="bg-dark-bg px-2">or continue with</span>
        </div>
      </div>
      <div className="flex gap-3">
        <a
          href="/api/auth/oauth/google"
          className="flex-1 flex items-center justify-center gap-2 py-2.5 border border-dark-border rounded-xl text-sm text-dark-text hover:bg-dark-surface transition"
        >
